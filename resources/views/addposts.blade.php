...
<section class="container mx-auto p-6">
   ...
   <form method="post" action="{{ route('addpost')}}" class="space-y-4">
    @csrf
    <div>
    ...
    <div>
        ...
        <input type="text" id="content" name="content" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
    </div>
    <div>
